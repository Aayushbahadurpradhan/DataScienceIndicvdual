...
uncleanedhouseprices = read_csv('cleanData/Combined_House_Pricing_2019-2022.csv')
...
View(FilteredTown)
write.csv(FilteredTown, "cleanData/Cleaned_Town_population.csv",row.names = FALSE)
